// could alternatively import right from Heroicons...

export function PlayIcon ({ size = 25, ...props}) {
  return (
...
export function UploadIcon({ size = 25, ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth={2}
      stroke="currentColor" width={size} height={size} viewBox="0 0 24 24" {...props}>
...
export function AnalyseIcon({ size = 25, ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
      strokeWidth={2} stroke="currentColor" width={size} height={size} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round"
...
export function RestartIcon({ size = 25, ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width={size} height={size} {...props}>
...
export function OptimisationIcon({ size = 25, ...props }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width={size} height={size} {...props}>
